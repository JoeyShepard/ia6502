...
#Symbols defined in assembly source like labels and textual symbols defined with .SET
global_symbols={}
...
class LineClass:
    ...
    def __reset(self):
        ...
        self.symbol_unknown=False           #Line contains undefined symbol? ie undefined label
        self.symbol_unknown_last=False      #When symbol_unknown is True, is unknown symbol last symbol on line?
        self.symbol_error=False             #Line contains error with symbols or syntax error?
        self.parentheses_balanced=False     #Opening and closing parentheses match?
